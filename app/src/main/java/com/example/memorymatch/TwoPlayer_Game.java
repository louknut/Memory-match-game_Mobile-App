...
public class TwoPlayer_Game extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.twoplayer_game);
        ...
        //changing the color of yhe second player (inactive)
    ...
    private void calculate() {
        ...
        if(firstCard == secondCard) {
            ...
            if(turn == 1) {
                p1Points++;
                p1.setText("Player1: " + p1Points);
            } else if(turn == 2) {
                p2Points++;
                p2.setText("Player2: " + p2Points);
            }
        } else {
    ...
    private void checkEnd() {
        if(iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(TwoPlayer_Game.this);
            alertDialogBuilder
                    .setMessage("GAME OVER!\n\nPlayer1: " + p1Points + " points\nPlayer2: " + p2Points + " points")
                    .setCancelable(false)
                    .setPositiveButton("PLAY AGAIN", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(getApplicationContext(), TwoPlayer_Game.class);

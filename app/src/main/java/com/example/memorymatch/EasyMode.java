...
public class EasyMode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Assign variable
        textView = findViewById(R.id.timeEasy);
        ...
        new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(EasyMode.this);
                alertDialogBuilder
                        .setMessage("TIME OUT!\n\nYou Lose")
                        .setCancelable(false)
    ...
    private void checkEnd() {
        if(iv_11.getVisibility() == View.INVISIBLE &&
            ...
            int lastTimeE = Integer.parseInt(timeE[1]);
            lastTimeE = 60 - lastTimeE;
            System.out.println(lastTimeE);

            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(EasyMode.this);
            alertDialogBuilder
                    .setMessage("GAME OVER!\n\nYou Win\nYour Time: 00:" + lastTimeE)
                    .setCancelable(false)
                    .setPositiveButton("PLAY AGAIN", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            SharedPreferences preferences = getSharedPreferences("EASY", 0);
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt("lastTimeEasy", lastTimeE);
            editor.apply();
